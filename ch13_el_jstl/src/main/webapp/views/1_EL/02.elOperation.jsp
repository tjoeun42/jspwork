...
<body>
	...
	sThree에 담긴값이 '안녕'과 일치합니까? ${ sThree == '안녕' } 또는 ${ sThree eq '안녕' }<br>
	...
	aOne은 텅비어있습니까? ${ empty aOne }<br>
	aTwo는 텅비어있습니까? ${ empty aTwo }<br>
	
	<h3>5. 논리연산자</h3>
	${ true && true } 또는 ${ true and true }<br>
	${ true || true } 또는 ${ true or true }<br>
	
	big이 small보다 크고 aOne은 텅 비어있습니까? ${ big gt small and empty aOne }
</body>
</html>